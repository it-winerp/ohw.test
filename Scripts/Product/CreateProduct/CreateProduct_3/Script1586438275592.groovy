...
WebUI.verifyElementVisible(findTestObject('Page_New Product - Odoo/div_The following fields are invalid'))

WebUI.verifyElementVisible(findTestObject('Page_New Product - Odoo/li_Name'))
